...
#define FANPIN    5                          // The pin we use to control the fan speed
...
//  OCR1A  = 15609;                                 // 16mhz / 1024 / 15609 = 1 Hz
  OCR1A  = 1561;                                 // 16mhz / 1024 / 1561 = 1/10th Hz
...
void loop() { 
  ...
  // we moved the LCD code into the functions so we don't have to worry about updating the LCD 
